...
public class NetworkTopologyApp
{
    ...
    public void General(InputStream is) throws Exception {
        try{
            logs = new logGeneratorStream(NetworkTopologyApp.class.getName());
        }
        catch(Exception e)
        {
        ...
        while(sc.hasNext())
        {
            ...
            if(str.contains("NetworkGraph --help"))
                GraphPoetHelper();
            if(str.contains("file --in"))
            {
                ...
                System.out.println("Graph Establish complete.\nUse \"NetworkGraph --help\" to see operates supported.");
                if(gp!=null)
