...
public class MovieGraphApp
{
    ...
    public void General(InputStream is) throws Exception {
        try{
            logs = new logGeneratorStream(MovieGraphApp.class.getName());
        }
        catch(Exception e)
        {
        ...
        System.out.println("MovieGraph App\nVersion=1.0.\nAuthor=marisuki\nUse \"MovieGraph --help\" to get details.");
        ...
        while(sc.hasNext())
        {
            ...
            if(str.contains("MovieGraph --help"))
                MovieGraphHelper();
            if(str.contains("file --in"))
            {
                ...
                {
                    try{
                        gp = (MovieGraph) generalInputHelper.fileReadConfig(filePath);
                        flag = true;
                    }
                    catch (MessageFieldIncorrectException | NoSuchTypeException mfe)
                    {
            ...
            else if(str.contains("degreeCentrality"))
            {
                ...
                {
                    Vertex tmp = generalInputHelper.stov(a[1]);
                    if(tmp!=null)
            ...
            else if(str.contains("distance"))
            {
                ...
                String[] a = str.split(" ");
                assert a.length==3;
                Vertex tmp1 = generalInputHelper.stov(a[1]);
                Vertex tmp2 = generalInputHelper.stov(a[2]);
            ...
            else if(str.contains("save"))
            {
                ...
                {
                    gp = (MovieGraph) generalInputHelper.recallSpecGra(a[2]);
                }
            }
    ...
    private void MovieGraphHelper()
    {
        StringWriter swt = new StringWriter();
        swt.write("MovieGraph App\nVersion=1.0.\nAuthor=marisuki\n");
